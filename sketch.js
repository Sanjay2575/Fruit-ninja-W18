...
function setup() {
kitchen = createSprite(windowWidth, windowHeight);
...
background(67, 79, 232);
 createCanvas(windowWidth, windowHeight, 200, 200); 
if(gameState===PLAY){  
fruits();
enemy();
...
monster=createSprite(1500,200,20,20);
...
function fruits(){
  if(World.frameCount%80===0){
    fruit=createSprite(1500,200,20,20);
    fruit.scale = 0.2
